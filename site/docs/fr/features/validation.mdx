---
title: Validation
description: Validation par colonne avec CellValidator — rejet des saisies invalides avant leur enregistrement.
---
...
- [API ColumnDef](/fr/api/column-def) — référence du type `CellValidator`

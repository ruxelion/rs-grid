---
title: Themes integres
description: Themes Light, Dark, Material 3 et Material 3 Dark.
---
...
Ou definissez tout via CSS — voir la [Reference des variables CSS](/theming/css-variables).

...
by the [rs-grid-example-js](https://github.com/ruxelion/rs-grid-example-js) repo.
This requires building with `wasm-pack`.
...
- `basic_js.js` — the JS glue
- `basic_js_bg.wasm` — the WASM binary

...
impl GridCanvas {
    ...
    /// Start a repeating scroll (arrows): immediate first scroll
    /// on mousedown, then ~350 ms pause, then repeat every 60 ms.
    ...
    /// AG Grid-style three-phase track scroll for horizontal.
